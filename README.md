...
- **TOC sidebar navigation** — Auto-generated table of contents sidebar on the left for quick navigation, with scroll tracking highlight and collapsible toggle
...
- Code highlighting is loaded from the [highlight.js](https://highlightjs.org/) CDN
- Math rendering is loaded from the [MathJax](https://www.mathjax.org/) CDN
